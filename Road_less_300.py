...
LAYER_NAME   = "TransportationGroundCurves"          # TOC name
SUBTYPE_NAMES = ["ROAD_C", "CART_TRACK_C", "TRAIL_C"]  # <- add/remove names here
# Optional hard-coded codes if you know them; names (above) will be resolved first.
FALLBACK_CODES = [100152]  # ROAD_C known; others resolved via names
